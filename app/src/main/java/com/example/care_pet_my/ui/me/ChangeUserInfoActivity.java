...
//        rl_title_bar.setBackgroundColor(Color.parseColor("#30B4FF"));
        ...
        //为保存按钮添加监听事件，首先通过标识码flag判断是哪个界面， 若是修改昵称界面，则保存新昵称，若是修改签名界面，则保存新签名。
    ...
    /**
     * 监听个人资料修改界面输入的文字
     * 监听EditText控件的输入文字，在onTextChanged()方法 中监听EditText的输入状态，
     * 若此时在修改昵称界面，则限制昵称不能超过8个字；若 此时在修改签名界面，则限制输入的字数不能超过16个字
     */
