package com.example.care_pet_my.ui.splash;
...
import com.example.care_pet_my.ui.login.RegisterActivity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        timer.schedule(task,2000);//timer.schedule用于开启TimerTask类 传递两个参数，第一个参数为TimerTask的对象，第二个参数为TimerTask和run()之间的时间差为3秒。
        //设置这个task在延迟2秒后自动执行
    }
